...
2. **Private Disclosure**: Use [GitHub's private vulnerability reporting](https://github.com/mcp-hangar/helm-charts/security/advisories/new) if available
...
These charts implement multiple security layers:

- **Pod Security Contexts**: Non-root containers, read-only filesystems, dropped capabilities
- **RBAC**: Minimal ClusterRole/Role permissions
- **Network Policies**: Configurable network isolation
- **Service Accounts**: Dedicated service accounts with least-privilege
